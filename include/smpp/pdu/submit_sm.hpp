...
{
  return std::tuple{ mem<c_octet_str<6>>(&submit_sm::service_type, "service_type"),
                     ...
                     mem<c_octet_str<17>>(&submit_sm::schedule_delivery_time, "schedule_delivery_time"),
                     ...
                     mem<enum_u8>(&submit_sm::replace_if_present_flag, "replace_if_present_flag"),
