...
{
  return std::tuple{ memv<c_octet_str<65>>(&query_sm::message_id, "message_id"),
                     memv<enum_u8>(&query_sm::source_addr_ton, "source_addr_ton"),
                     memv<enum_u8>(&query_sm::source_addr_npi, "source_addr_npi"),
                     memv<c_octet_str<21>>(&query_sm::source_addr, "source_addr") };
}
} // namespace detail
} // namespace smpp
