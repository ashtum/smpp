...
BOOST_AUTO_TEST_CASE(serialize_deserialize)
{
    ...
    auto check = [](const auto& pdu)
    {
        ...
        auto deserialzied_pdu =
            smpp::deserialize<pdu_t>({ buf.begin(), buf.end() });
    ...
    oparam.set_as_enum_u8(
        smpp::oparam_tag::message_state, smpp::message_state::expired);

    check(smpp::bind_transceiver{
        .system_id         = "L::DSFKLS:F",
        .password          = "984DJAS9",
        .system_type       = "JSUHGD",
    ...
    check(smpp::bind_transceiver_resp{ .system_id = "SDSSIERYHFMN",
                                       .oparam    = oparam });

    check(smpp::bind_transmitter{
        .system_id         = "L::DSFKLS:F",
        .password          = "984DJAS9",
        .system_type       = "JSUHGD",
        .interface_version = smpp::interface_version::smpp_3_4,
    ...
    check(smpp::bind_transmitter_resp{ .system_id = "SDSSIERYHFMN",
                                       .oparam    = oparam });

    check(smpp::bind_receiver{
        .system_id         = "L::DSFKLS:F",
        .password          = "984DJAS9",
        .system_type       = "JSUHGD",
        .interface_version = smpp::interface_version::smpp_3_4,
    ...
    check(smpp::bind_receiver_resp{ .system_id = "SDSSIERYHFMN",
                                    .oparam    = oparam });
    ...
    check(smpp::data_sm{
        ...
        .registered_delivery =
            smpp::registered_delivery{
                smpp::smsc_delivery_receipt::failed,
    ...
    check(smpp::deliver_sm{
        ...
        .validity_period        = "",
        .registered_delivery =
            smpp::registered_delivery{ smpp::smsc_delivery_receipt::both,
    ...
    check(smpp::submit_sm{
        ...
        .registered_delivery =
            smpp::registered_delivery{ smpp::smsc_delivery_receipt::failed,
                                       smpp::sme_originated_ack::user_ack,
                                       smpp::intermediate_notification::no },
